describe Knapsack::TaskLoader do
  describe '#load_tasks' do
    ...
    let(:parallel_rspec_rake_task_path) { "#{Knapsack.root}/lib/tasks/knapsack_parallel_rspec.rake" }
    ...
    it do
      ...
      expect(subject).to receive(:import).with(parallel_rspec_rake_task_path)
